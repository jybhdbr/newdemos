...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=1444828305810485&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fmanufacturing%2Flakehouse-iot-platform%2F02-Data-governance%2F02-UC-data-governance-security-iot-turbine&uid=7718718868639865">
...
-- MAGIC %run ../_resources/00-load-tables $reset_all_data=true $catalog=dbdemos $db=lakehouse_iot
...
GRANT SELECT ON TABLE dbdemos.lakehouse_iot.part TO `analysts`;
GRANT SELECT ON TABLE dbdemos.lakehouse_iot.sensor_bronze TO `analysts`;
GRANT SELECT ON TABLE dbdemos.lakehouse_iot.sensor_hourly TO `analysts`;
...
SHOW GRANT ON dbdemos.lakehouse_iot.turbine

-- COMMAND ----------

SELECT * FROM dbdemos.lakehouse_iot.turbine;
