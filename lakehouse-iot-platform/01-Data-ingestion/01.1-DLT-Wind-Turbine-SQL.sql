...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=1444828305810485&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fmanufacturing%2Flakehouse-iot-platform%2F01-Data-ingestion%2F01.1-DLT-Wind-Turbine-SQL&uid=7718718868639865">
...
-- MAGIC %md
-- MAGIC Your DLT Pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="dlt-iot-wind-turbine" href="#joblist/pipelines/1c10660f-6ad4-4168-9dee-8358d9940763" target="_blank">IOT Wind Turbine Delta Live Table pipeline</a> to see it in action.<br/>
-- MAGIC 
...
-- MAGIC 
-- MAGIC ## Conclusion
-- MAGIC Our <a dbdemos-pipeline-id="dlt-iot-wind-turbine" href="#joblist/pipelines/1c10660f-6ad4-4168-9dee-8358d9940763" target="_blank">DLT Data Pipeline</a> is now ready using purely SQL. We have an end 2 end cycle, and our ML model has been integrated seamlessly by our Data Engineering team.
-- MAGIC 
-- MAGIC 
...
-- MAGIC 
-- MAGIC We are now ready to build our <a href="/sql/dashboards/e3011ace-8437-40ef-9ba2-5aa7685bccfe">DBSQL Dashboard</a>to track the main KPIs and status of our entire Wind Turbine Farm and build complete <a href="/sql/dashboards/73c61ddc-cf11-48e1-88ee-ad2f04ee6b9f">Predictive maintenance DBSQL Dashboard</a>. 
-- MAGIC 
-- MAGIC 
