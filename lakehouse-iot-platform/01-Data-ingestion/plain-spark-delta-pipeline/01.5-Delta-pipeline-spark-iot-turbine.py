...
# MAGIC To run this demo, just select the cluster `demo-lakehouse-iot-platform-jyotsna_bharadwaj` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0201-142739-6j7dmyj6/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=1444828305810485&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fmanufacturing%2Flakehouse-iot-platform%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-iot-turbine&uid=7718718868639865">

# COMMAND ----------

# MAGIC %run ../../_resources/00-setup $reset_all_data=$reset_all_data $catalog="" $db=""
...
# MAGIC 
# MAGIC 
# MAGIC Switch to Databricks SQL to see how this data can easily be requested with the [Turbine DBSQL Dashboard](/sql/dashboards/e3011ace-8437-40ef-9ba2-5aa7685bccfe) to start reviewing our Wind Turbine stats or the [DBSQL Predictive maintenance Dashboard](/sql/dashboards/73c61ddc-cf11-48e1-88ee-ad2f04ee6b9f).
# MAGIC 
