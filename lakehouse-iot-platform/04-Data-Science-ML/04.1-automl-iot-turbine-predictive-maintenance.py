...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=1444828305810485&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fmanufacturing%2Flakehouse-iot-platform%2F04-Data-Science-ML%2F04.1-automl-iot-turbine-predictive-maintenance&uid=7718718868639865">

# COMMAND ----------

# MAGIC %run ../_resources/00-load-tables $reset_all_data=false $catalog="hive_metastore" $db=""
...
# MAGIC 
# MAGIC <a href='/sql/dashboards/73c61ddc-cf11-48e1-88ee-ad2f04ee6b9f'>Open the Predictive Maintenance DBSQL dashboard</a> | [Go back to the introduction]($../00-IOT-wind-turbine-introduction-lakehouse)
# MAGIC 
